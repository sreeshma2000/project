                            ...
                            <div class="img-wrapper">
                                ...
                                <div class="cart-wrap">
                                    <ul>
                                        ...
                                        <li>
    <a href="javascript:void(0)" onclick="addToProductWishlist({{ $product->id }}, '{{ $product->name }}', 1, {{ $product->regular_price }})" class="wishlist">
        <i data-feather="heart"></i>
                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    ...
                                    <h3 class="theme-color">Rs.{{$product->regular_price}}</h3>
...
@push("scripts")
    <script>
       $(function(){
        ...
        //     $('#frmFliter').submit();
        // }
        function addToProductWishlist(id, name, quantity, price) {
            $.ajax({
                type: 'POST',
