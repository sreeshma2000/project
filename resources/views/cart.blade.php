                ...
                <table class="table cart-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <h2 class="td-color">Rs.{{$item->subtotal()}}</h2>
                            </td>
                            <td>
                            ...
                            <div class="cart-box-details">
                                <div class="total-details">
                                    <div class="top-details">
                                        <h3>Cart Totals</h3>
                                        <h6>Sub Total <span>Rs.{{Cart::instance('cart')->subtotal()}}</span></h6>
                                        <h6>Tax <span>Rs.{{Cart::instance('cart')->tax()}}</span></h6>

                                        <h6>Total <span>Rs.{{Cart::instance('cart')->total()}}</span></h6>
                                    </div>
